...
- Carbs target enabled.
- Fat target enabled.
- Protein target enabled.
- Burned target enabled at 500 kcal default.
- Steps target enabled at 10,000 default.
- Water target enabled and displayed in litres (2.7 L default), while preserving legacy mL storage compatibility.
